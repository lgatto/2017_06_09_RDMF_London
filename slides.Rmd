...
<!-- I consider myself a modern digital scholar, active and competent with -->
<!-- data and software, open and collaborative research and development, and -->
<!-- dissemination of my research. I might even dare to say that I am -->
<!-- scientifically reasonably successful, with regular scientific -->
<!-- publication and grant acceptance in my research domain which is -->
...
<!-- modern, digital and data-oriented researchers drive change and -->
<!-- innovation, in particular in the current climate of -->
...
- **Inclusive** and **respectful**, for example of under represented
  minorities (see
...
- useful for others (researchers, public, ...) -- a *good* thing;
  altruism
- useful for me (open leads to transparent and reproducible research,
  trust, visibility) -- selfish
...
- **Closed**: scooping, perceived quality, risk averse,
  mis-understanding.
- **Open**: demonstrate your confidence, stand out, show that you can
...
- the support researchers' needs in order to make *all* aspects of
  their research open,
- why researchers want to do this,
...
- (Many of) the **senior academics** and **managers** (i.e. those in a
  ...
  science, and have no incentive to change.
  
## Do we want more OS?  Who wants more OS?
  
**Institutions**: please, do support your ECRs in their efforts to
promote Open Science, include them in decision making, **listen to
them** - **expect openness** in hiring and promotion:
[DORA](http://www.ascb.org/dora/), pre-prints, support/train staff
(for example OSC in Cambridge).

## Do we want more OS?  Who wants more OS?

**Funders**, do you want to support Open Research? **Do it!** 

Funders are ideally positioned to drive change and to **support OS and
ECR**, who are often the most skilled in OS and data/software
mangement practice. We need an **(open) science investigator
awards**. 

But, in my opinion, too shy.
...
<!-- have dedicates data and software management plan though, and provide -->
...
Large             Small
QC                Testing
DMP               [SMP](http://riojournal.com/articles.php?id=11624)
...
- [Blog posts](https://lgatto.github.io/tags/#open-research-project)
  about the OSC/WT
  [Open Research Project](http://osc.cam.ac.uk/open-research/open-research-pilot-project).


## Acknowledgements

- [OpenConCam](http://openconcam.org/)
- [Corina Logan](http://corinalogan.com/), [Stephen Eglen](https://sje30.github.io/), Yvonne Nobis
- [Office of Scholarly Communication](Office of Scholarly Communication)
